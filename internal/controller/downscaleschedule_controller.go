...
// DownscaleScheduleReconciler reconciles a DownscaleSchedule object
...
// +kubebuilder:rbac:groups=downscaler.sipher.gg,resources=downscaleschedules/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the DownscaleSchedule object against the actual cluster state, and then
